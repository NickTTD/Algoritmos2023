...
class Grafo():
    ...
    def barrido_maravilla_compartePais(self): #Estoy casi seguro que hay una mejor manera de hacer esto...
        for i in range(len(self.__elements)):
            ...
            if coincidentes:
                print(f"Maravillas en {vertice1[0].pais} con el mismo país:")
                print(vertice1[0])
